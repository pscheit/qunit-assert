define(['jquery', 'qunit', 'joose', 'knockout'], function ($, QUnit, Joose, ko) {
    ...
    return {
      ...
      assertException: function(expectedException, block, expectedMessage, debugMessage, assertions) {
        var assert = function assertException(e) {
          ...
          QUnit.push( isException, isException, true, this.formatMessage(baseAssertions.debug(e)+" is instanceof Psc.Exception", isException) );
  ...
  // deprecated alias
  baseAssertions.assertDoesRole = baseAssertions.assertJooseDoesRole;
